...
class TeamsController extends Controller
{
    ...
    {
        if (!empty($request->id)) {
            $data['data'] = Team::where(['id'=>$request->id])->first();
        }
    ...
    public function save(Request $request){
        ...
        if($validator->passes()) {
            ...
            $formdata['education'] = $request->education;
            $formdata['description'] = $request->desc;
            $formdata['teamType'] = $request->teamType;
            ...
            if (!empty($id)) {
                ...
                $row = Team::where('id',$id)->update($formdata);
                $row=$id;
                $msg = 'Data Updated';
            }else{
                $formdata['added_by'] = Auth::user()->id;
                $row = Team::insertGetId($formdata);
                $msg = 'Data Inserted';
    ...
    public function delete(Request $request){
        ...
        $row = Team::where('id',$request->id)->update($data);
